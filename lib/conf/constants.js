...
module.exports = {
  EP_STATS_CONFIG_DIR_PATH,

  // Google authorization part
  CREDENTIALS_PATH: resolvePath(EP_STATS_CONFIG_DIR_PATH, 'google_credentials.json'),
  TOKEN_PATH: resolvePath(EP_STATS_CONFIG_DIR_PATH, 'google_token.json'),
  SCOPES: [
